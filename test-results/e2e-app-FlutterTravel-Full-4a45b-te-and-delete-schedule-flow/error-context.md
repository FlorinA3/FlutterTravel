...
- Name: FlutterTravel Full App E2E >> Create, update, and delete schedule flow
- Location: C:\Users\Alexx\Desktop\app\munca\FlutterTravel\e2e\app.test.ts:33:3
...
Call log:
  - waiting for locator('a#nav-schedules') to be visible

    at C:\Users\Alexx\Desktop\app\munca\FlutterTravel\e2e\app.test.ts:34:43
```
